...
ai_engine = create_engine(ai_url, pool_size=10, max_overflow=20, pool_recycle=3600, echo=settings.DEBUG)
...
source_engine = create_engine(src_url, pool_size=5, max_overflow=10, pool_recycle=3600, echo=False)
