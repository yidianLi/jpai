<template>
  <div class="page-shell"><header class="page-head"><div><span class="page-kicker">PURCHASE INSIGHT</span><h2>品牌表现</h2><p>支持按资产类别比较品牌，也支持直接查询指定品牌；样本不足时不作强推荐。</p></div></header>
...
<style scoped>.page-shell{display:grid;gap:16px}.page-head{display:flex;align-items:flex-end}.page-kicker{font-size:11px;letter-spacing:1.6px;color:#1769aa}.page-head h2{margin:4px 0 6px;font-size:24px}.page-head p,.hint{color:#718198;font-size:13px}.toolbar{display:flex;align-items:center;gap:10px;margin-bottom:16px;flex-wrap:wrap}.hint{margin-right:auto}</style>
