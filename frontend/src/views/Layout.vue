...
.sidebar { display:flex; flex-direction:column; background:#10233f; color:#dce7f5; border-right:1px solid #1d385d; }
.brand { display:flex; gap:12px; align-items:center; padding:24px 22px; border-bottom:1px solid #1d385d; }
.brand-mark { width:36px; height:36px; display:grid; place-items:center; color:#62b0ff; background:#173b66; border-radius:10px; font-size:20px; }
.brand strong { display:block; font-size:17px; color:#fff; letter-spacing:.5px; }.brand span { display:block; margin-top:3px; color:#88a3c4; font-size:10px; }
.workspace-label { padding:22px 22px 8px; color:#7895b8; font-size:11px; text-transform:uppercase; letter-spacing:1.5px; }
.nav-menu { border:0; background:transparent; padding:0 10px; }.nav-menu :deep(.el-sub-menu__title), .nav-menu :deep(.el-menu-item) { height:46px; color:#b5c7de; border-radius:8px; margin:3px 0; }.nav-menu :deep(.el-menu-item small) { margin-left:auto; color:#6e8daf; font-size:10px; }.nav-menu :deep(.el-sub-menu__title:hover), .nav-menu :deep(.el-menu-item:hover) { background:#173557; color:#fff; }.nav-menu :deep(.el-menu-item.is-active) { background:#1d6bb5; color:#fff; font-weight:600; }.nav-menu :deep(.el-menu) { background:transparent; }.nav-menu :deep(.el-sub-menu .el-menu-item) { padding-left:52px!important; min-width:0; }
.sidebar-footer { margin-top:auto; padding:18px 22px; color:#6f89a9; font-size:11px; border-top:1px solid #1d385d; }
